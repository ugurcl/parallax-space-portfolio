...
export default function Contact() {
  ...
  const titleY = useTransform(scrollYProgress, [0, 0.2, 0.85, 1], [60, 0, 0, -60]);

  const leftX = useTransform(scrollYProgress, [0.05, 0.3, 0.75, 0.95], [-300, 0, 0, -300]);
  const leftOpacity = useTransform(scrollYProgress, [0.05, 0.3, 0.75, 0.95], [0, 1, 1, 0]);

  const rightX = useTransform(scrollYProgress, [0.1, 0.35, 0.7, 0.9], [300, 0, 0, 300]);
  const rightOpacity = useTransform(scrollYProgress, [0.1, 0.35, 0.7, 0.9], [0, 1, 1, 0]);
    ...
    <section className="contact" id="contact" ref={sectionRef}>
      ...
      <div className="container">
        ...
        <div className="contact-wrapper">
          <motion.div className="contact-info" style={{ x: leftX, opacity: leftOpacity }}>
